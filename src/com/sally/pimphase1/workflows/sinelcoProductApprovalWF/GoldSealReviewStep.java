...
public class GoldSealReviewStep implements WorkflowStepFunction {
	...
	private void publishXML(Context ctx, Catalog sallyCatalog, StringWriter stringWriter,
		...
		for (Iterator<LookupTableEntry> iterator = lkpEntries.iterator(); iterator.hasNext();) {
			...
			if(lookupTableEntry.getAttributeValue("AzureConstantsLookupSpecs/key").toString().equalsIgnoreCase("OutboundLocalPublishFilePath")) {
			...
			if(lookupTableEntry.getAttributeValue("AzureConstantsLookupSpecs/key").toString().equalsIgnoreCase("OutboundPublishWorkingDirectory")) {
		...
		xmlStreamWriter.writeStartElement("Value");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_INNER_PACK_HEIGHT_VALUE) == null) ? ""
				: item.getAttributeValue(Constants.PACKAGING_INNER_PACK_HEIGHT_VALUE).toString()));
		xmlStreamWriter.writeEndElement();
		
		xmlStreamWriter.writeStartElement("UOM");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_INNER_PACK_HEIGHT_UOM) == null) ? ""
		...
		xmlStreamWriter.writeStartElement("Value");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_INNER_PACK_WIDTH_VALUE) == null) ? ""
		...
		xmlStreamWriter.writeStartElement("Value");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_INNER_PACK_DEPTH_VALUE) == null) ? ""
		...
		xmlStreamWriter.writeStartElement("Value");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_INNER_PACK_WEIGHT_VALUE) == null) ? ""
				: item.getAttributeValue(Constants.PACKAGING_INNER_PACK_WEIGHT_VALUE).toString()));
		xmlStreamWriter.writeEndElement();
		
		xmlStreamWriter.writeStartElement("UOM");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_INNER_PACK_WEIGHT_UOM) == null) ? ""
		...
		AttributeInstance innerPackMaterialInst = item.getAttributeInstance(Constants.PACKAGING_INNER_PACKAGING_MATERIAL);
		...
		if (innerPackMaterialInst != null) {
			for (int x = 0; x < innerPackMaterialInst.getChildren().size(); x++) {
				...
				xmlStreamWriter.writeCharacters(
						((item.getAttributeValue(Constants.PACKAGING_INNER_PACKAGING_MATERIAL + "#" + x + "/Material_type") == null) ? ""
								: item.getAttributeValue(Constants.PACKAGING_INNER_PACKAGING_MATERIAL + "#" + x + "/Material_type")
										.toString()));
				xmlStreamWriter.writeEndElement();
				
				xmlStreamWriter.writeStartElement("Value");
				xmlStreamWriter.writeCharacters(
						((item.getAttributeValue(Constants.PACKAGING_INNER_PACKAGING_MATERIAL + "#" + x + "/Value") == null) ? ""
								: item.getAttributeValue(Constants.PACKAGING_INNER_PACKAGING_MATERIAL + "#" + x + "/Value")
										.toString()));
				xmlStreamWriter.writeEndElement();
			}
		}
		...
		xmlStreamWriter.writeStartElement("Value");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_OUTER_PACK_HEIGHT_VALUE) == null) ? ""
				: item.getAttributeValue(Constants.PACKAGING_OUTER_PACK_HEIGHT_VALUE).toString()));
		xmlStreamWriter.writeEndElement();
		
		xmlStreamWriter.writeStartElement("UOM");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_OUTER_PACK_HEIGHT_UOM) == null) ? ""
		...
		xmlStreamWriter.writeStartElement("Value");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_OUTER_PACK_WIDTH_VALUE) == null) ? ""
		...
		xmlStreamWriter.writeStartElement("Value");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_OUTER_PACK_DEPTH_VALUE) == null) ? ""
		...
		xmlStreamWriter.writeStartElement("Value");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_OUTER_PACK_WEIGHT_VALUE) == null) ? ""
				: item.getAttributeValue(Constants.PACKAGING_OUTER_PACK_WEIGHT_VALUE).toString()));
		xmlStreamWriter.writeEndElement();
		
		xmlStreamWriter.writeStartElement("UOM");
		xmlStreamWriter.writeCharacters(((item.getAttributeValue(Constants.PACKAGING_OUTER_PACK_WEIGHT_UOM) == null) ? ""
		...
		AttributeInstance outerPackMaterialInst = item.getAttributeInstance(Constants.PACKAGING_OUTER_PACKAGING_MATERIAL);

		if (outerPackMaterialInst != null) {
			for (int x = 0; x < outerPackMaterialInst.getChildren().size(); x++) {
				xmlStreamWriter.writeStartElement("Material_type");
				xmlStreamWriter.writeCharacters(
						((item.getAttributeValue(Constants.PACKAGING_OUTER_PACKAGING_MATERIAL + "#" + x + "/Material_type") == null) ? ""
								: item.getAttributeValue(Constants.PACKAGING_OUTER_PACKAGING_MATERIAL + "#" + x + "/Material_type")
										.toString()));
				xmlStreamWriter.writeEndElement();
				
				xmlStreamWriter.writeStartElement("Value");
				xmlStreamWriter.writeCharacters(
						((item.getAttributeValue(Constants.PACKAGING_OUTER_PACKAGING_MATERIAL + "#" + x + "/Value") == null) ? ""
								: item.getAttributeValue(Constants.PACKAGING_OUTER_PACKAGING_MATERIAL + "#" + x + "/Value")
										.toString()));
				xmlStreamWriter.writeEndElement();
			}
		}
		...
		doc = ctx.getDocstoreManager().createAndPersistDocument("/outbound/ItemPublish/Working/" + item.getPrimaryKey() + ".xml");
