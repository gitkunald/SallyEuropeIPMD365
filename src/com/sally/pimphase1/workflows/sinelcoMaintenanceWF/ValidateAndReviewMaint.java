...
//script_execution_mode=java_api="japi:///uploaded_java_classes/:com.sally.pimphase1.workflows.sinelcoMaintenanceWF.ValidateAndReviewMaint.class"
...
public class ValidateAndReviewMaint implements WorkflowStepFunction {
	
	Logger logger = LogManager.getLogger(ValidateAndReviewMaint.class);
